...
// class TestingControls extends BaseAudioHandler {
...
//       if (_music.albums.where((element) => element.isPlaying).length > 0) {
//         assert(_music.artists.where((e) => e.isPlaying).isEmpty);
//         list = _music.albums.firstWhere((element) => element.isPlaying).tracks!;
//       } else if (_music.artists.where((element) => element.isPlaying).length >
//           0) {
//         assert(_music.albums.where((e) => e.isPlaying).isEmpty);
//         list =
//             _music.artists.firstWhere((element) => element.isPlaying).tracks!;
//       } else {
//         list = _music.songs;
//       }

//       // list = _music.albums.firstWhere((album) => album.isPlaying).tracks ??
//       //     _music.songs;
//       // _music.currentSongs.isEmpty ? _music.songs : _music.currentSongs;
